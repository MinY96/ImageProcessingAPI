...
정상 이미지와 Mask/Asset을 기반으로 제조 비전용 Synthetic NG를 생성하는 독립 계층을 추가했습니다.

- Procedural: blob, stain, droplet, pooling, crack, speck, texture
- CutPaste / Alpha Blend / OpenCV Seamless Clone
- CCTV 환경을 위한 color/noise/blur matching Asset Composite
- 재사용 가능한 Defect Asset Library
